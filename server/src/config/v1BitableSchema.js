  ...
  tables: {
    ...
    inventoryLedger: {
      ...
      fields: {
        ...
        operator: '操作人',
        postingStatus: '入账状态',
        failureReason: '备注/失败原因',
        size: '尺码',
        product: '编号',
        reversedLedger: '冲销原库存流水',
        behavior: '库存行为',
      },
    },
    liveInventory: {
    ...
    moneyLedger: {
      tableName: '资金流水',
      tableId: getEnv('FEISHU_V1_MONEY_LEDGER_TABLE_ID', 'tblnaGV5zKruqUJI'),
      fields: {
        flowId: '资金流水ID',
        sourceNo: '来源单号',
        direction: '收支方向',
        ...
        operator: '经办人',
        postingStatus: '入账状态',
        reversedFlow: '冲销原资金流水',
        remark: '备注',
        supplier: '供应商',
        otherCounterparty: '其他对方名称',
        behavior: '资金行为',
      },
    },
    supplierPayable: {
      tableName: '供应商往来货款',
      tableId: getEnv('FEISHU_V1_SUPPLIER_PAYABLE_TABLE_ID', 'tblTtR1rSUjj5npj'),
      fields: {
        flowId: '供应商往来流水ID',
        supplier: '供应商',
        sourceNo: '来源单号',
